...
@section('title',trans('admin.project_budget'))
@section('page')
    <div class="row">
        <div class="col-12 col-md-5">
            <div class="card has-shadow">
                <div class="card-header bordered no-actions"><h4>{!! trans('admin.category') !!}</h4></div>
                <form method="post" @if(isset($edit)) action="/admin/project/budget/edit/store/{!! $edit->id !!}" @else action="/admin/project/budget/new/store" @endif>
                    <div class="card-body">
                            ...
                            @foreach($list as $item)
                                <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="/admin/project/budget/edit/{!! $item->id !!}" title="{!! trans('admin.edit') !!}"><i class="fas fa-edit"></i></a>
                                            <a class="delete-item" href="/admin/project/budget/delete/{!! $item->id !!}" title="{!! trans('admin.delete') !!}"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                            @endforeach
                            </tbody>
