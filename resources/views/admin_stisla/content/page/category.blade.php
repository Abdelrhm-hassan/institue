    ...
    <div class="row">
        <div class="col-5">
            <div class="card has-shadow">
                <form method="post" @if(!isset($edit)) action="/admin/page/category/new/store" @else action="/admin/page/category/edit/store/{!! $edit->id !!}" @endif>
                    <div class="card-body">
                        ...
                        @foreach($list as $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a title="{{ trans('admin.edit') }}" href="/admin/page/category/edit/{!! $item->id !!}"><i class="fas fa-edit"></i></a>
                                    <a class="delete-item" href="/admin/page/category/delete/{!! $item->id !!}"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
