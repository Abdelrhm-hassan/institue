                    ...
                    @foreach($list as $item)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="/blog/{!! $item->id !!}" target="_blank" title="{{ trans('admin.view_content') }}"><i class="fas fa-eye"></i></a>
                                <a href="/admin/blog/edit/{!! $item->id !!}"><i class="fas fa-edit"></i></a>
                                <a class="delete-item" href="/admin/blog/delete/{!! $item->id !!}"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
