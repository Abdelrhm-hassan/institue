    ...
    <div class="row">
        <div class="col-12 col-md-5">
            <div class="card has-shadow">
                <div class="card-header bordered no-actions">{!! trans('admin.category') !!}</div>
                <form method="post" @if(isset($edit)) action="/admin/revision/category/edit/store/{!! $edit->id !!}" @else action="/admin/revision/category/new/store" @endif>
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" style="height: 200px;" name="description">{!! $edit->description ?? '' !!}</textarea>
                        </div>
                        <div class="form-group">
                            <label>{!! trans('admin.order') !!}</label>
                            <input type="number" required class="form-control" min="1" name="sort" value="{!! $edit->sort ?? '' !!}">
                        </div>
                        <div class="form-group">
                                ...
                                @if($item->parent_id == null)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="/admin/revision/category/edit/{!! $item->id !!}" title="{!! trans('admin.edit') !!}"><i class="fas fa-edit"></i></a>
                                            <a class="delete-item" href="/admin/revision/category/delete/{!! $item->id !!}" title="{!! trans('admin.delete') !!}"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                @endif
                            @endforeach
