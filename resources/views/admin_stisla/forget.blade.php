            ...
            <div class="row">
                <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                    <div class="login-brand">
                        <img src="/assets/stisla/img/logo.png" alt="logo" width="300">
                    </div>

                    <div class="card card-primary">
                        <div class="card-header"><h4>{{ trans('admin.forget_password') }}</h4></div>

                        <div class="card-body">
                            <form method="POST" action="{{ route('submitRequestpassword') }}">
                                @csrf
