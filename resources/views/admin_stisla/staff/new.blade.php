...
@section('title',trans('admin.new_staff'))
@section('page')
    <div class="card has-shadow">
        <div class="card-header bordered no-actions d-flex align-items-center">
            @if(isset($edit))
                <h4>{{ trans('admin.staff') }}</h4>
            @else
                <h4>{{ trans('admin.new_staff') }}</h4>
            @endif
        </div>
        <form method="post" @if(isset($edit)) action="/admin/staff/edit/store/{!! $edit->id !!}" @else action="/admin/staff/new/store" @endif>
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-md-2 mb-2">
                            <div class="styled-checkbox">
                                <input type="checkbox" value="staff" name="access[]" id="ch-3" @if(isset($edit) && inJson('staff', $edit->access)) checked @endif>
                                <label for="ch-3">{{ trans('admin.staff') }}</label>
                            </div>
                        </div>
                        <div class="col-6 col-md-2 mb-2">
                            <div class="styled-checkbox">
                                <input type="checkbox" value="garage" name="access[]" id="ch-3" @if(isset($edit) && inJson('garage', $edit->access)) checked @endif>
                                <label for="ch-3">{{ trans('admin.garage') }}</label>
                            </div>
                        </div>
                        <div class="col-6 col-md-2 mb-2">
                            <div class="styled-checkbox">
