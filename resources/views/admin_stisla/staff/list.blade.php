...
@section('title',trans('admin.list_of_staff'))
@section('page')
<div class="card has-shadow">
    ...
    <div class="card has-shadow">
        <div class="card-header bordered no-actions d-flex align-items-center">
            <h4>{{ trans('admin.list_of_staff') }}</h4>
        </div>
                        ...
                        @foreach($list as $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="/admin/staff/edit/{!! $item->id !!}"><i class="fas fa-edit"></i></a>
                                    <a class="delete-item" href="/admin/staff/delete/{!! $item->id !!}"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
