    ...
    <div class="row">
        <div class="col-12 col-md-9">
            <div class="card has-shadow send-project-card">
                <div class="card-header bordered no-actions"><h4>{{ trans('admin.submit_project') }}</h4></div>
                <form id="online-form" action="/user/online/new/store" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="file" id="file" accept="image/x-png,image/jpeg" class="form-control" required>
                        </div>
                    </div>
                    <div class="card-footer text-right">
                        <button type="submit" class="btn btn-primary btn-send-file">{{ trans('admin.send') }}</button>
                    </div>
                </form>
            </div>
        ...
        <div class="col-12 col-md-3">
            <div class="card has-shadow mb-3">
                <div class="card-header bordered no-actions"><h4>{{ trans('admin.calculate_the_estimated_price') }}</h4></div>
                <div class="card-body text-center">
                    <h2 style="color: green" id="process_price">{{ getOption('online_price_per_page','0') ?? '0' }}</h2>
                    <sub>{{ trans('admin.usd') }}</sub>
                </div>
                <div class="card-footer bg-danger">
                    <strong style="color: white;">{{ trans('admin.the_price_is_calculated_based_on_the_number_of_pages_you_advertise_and_it_is_possible_to_change_the_final_price') }}</strong>
                </div>
            </div>
