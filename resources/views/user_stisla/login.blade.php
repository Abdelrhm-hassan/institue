...
<head>
    ...
    <title>{{ getOption('site_title') }} - {{ trans('admin.user_panel') }}</title>
    ...
    <section class="section">
        <div class="d-flex flex-wrap align-items-stretch">
            <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                ...
                <div class="p-4 m-3">
                    <form method="POST" action="/user/login/do" class="needs-validation" novalidate="">
                        ...
                        <div class="form-group text-right">
                            <a href="/user/forget" class="float-left mt-3">
                        ...
                        <div class="py-3 text-center">
                            <a href="/user/register">{{ trans('admin.do_not_have_an_account_yet_Register_now') }}</a>
                        </div>
                    </form>
                </div>
            </div>
