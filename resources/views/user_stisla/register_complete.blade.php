    ...
    <section class="section">
        <div class="d-flex flex-wrap align-items-stretch">
            <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                ...
                <div class="p-4 m-3">
                    <form method="POST" action="/user/register/email/complete" class="needs-validation" novalidate="">
                        <div class="form-group">
                            <label for="email">{{ trans('admin.email') }}</label>
                            <input type="hidden" name="email" value="{{ $email ?? '' }}">
                            <input class="form-control" value="{{ $email ?? '' }}" tabindex="1" disabled>
                        ...
                        @if($mode == 'new')
                            <div class="form-group">
                                <label for="email">{{ trans('admin.user_name') }}</label>
                                <input class="form-control" name="name" tabindex="1">
                                <div class="invalid-feedback">
                                    {{ trans('admin.fill_empty_filed') }}
                                </div>
                            </div>
                        @endif
                        <div class="form-group">
                            <label for="email">{{ trans('admin.code') }}</label>
                            <input class="form-control text-center" name="code" tabindex="1">
                            <div class="invalid-feedback">
                                {{ trans('admin.fill_empty_filed') }}
                            </div>
                        </div>
