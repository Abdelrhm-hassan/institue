...
### Typeahead support
Integrates with Twitter Bootstraps' 2.3.2 typeahead.js, or use custom typeahead.js when using Bootstrap 3.
...
- 0.4
  - [Fix typeahead.js when using Bootstrap 3](https://github.com/bootstrap-tagsinput/bootstrap-tagsinput/pull/73)
- 0.3.13
